...
@IBDesignable class View: UIView {
    ...
    @IBInspectable var isNavigationBar :Bool = false {
    ...
    @IBInspectable var bottomlineHeight : CGFloat = 0{
    ...
    @IBInspectable var isBottomLineInverted : Bool = false {
    ...
    @IBInspectable var isTopRightClipped : Bool = false {
        didSet{
            add(rectCorner: .topRight, isAdd: isTopRightClipped)
        }
    }
    
    @IBInspectable var isBottomRightClipped : Bool = false {
        didSet{
            add(rectCorner: .bottomRight, isAdd: isBottomRightClipped)
        }
    }
    
    @IBInspectable var isTopLeftClipped : Bool = false {
        didSet{
            add(rectCorner: .topLeft, isAdd: isTopLeftClipped)
        }
    }
    
    @IBInspectable var isBottomLeftClipped : Bool = false {
        didSet{
